				...
				<div class="left_part wow fadeInLeft" data-wow-duration="1s">
					<div class="left_top">
						...
						<ul>
							...
							<li>
								<h4>Mobile</h4>
								<p><a href="tel:+998935798414">+998 93 579 84 14</a></p>
							</li>
							<li>
								<h4>Whatsapp</h4>
								<p>+998 93 579 84 14</p>
							</li>
							<li>
								<h4>Email</h4>
								<p><a href="mailto:mkshokirjon@gmail.com">hello@turistman.uz</a></p>
							</li>
						</ul>
					</div>
