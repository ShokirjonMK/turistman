...
* @var yii\data\ActiveDataProvider $dataProvider
    * @var common\models\search\FeaturesSearch $searchModel
*/
...
?>
<div class="giiant-crud features-index">
...
//             echo $this->render('_search', ['model' =>$searchModel]);
    ...
    <div class="table-responsive">
        ...
        'columns' => [
			...
			[
				'attribute' => 'image',
				'value' => function (\common\models\Features $model){
			...
			[
				'attribute' => 'images',
				'value' => function (\common\models\Features $model){
					return $model->getPhotoSrcBanner();
				},
				'format' => ['image', ['width' => 100, 'height' => 50]]
			],
                ]
