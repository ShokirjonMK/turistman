...
* @var yii\data\ActiveDataProvider $dataProvider
    * @var common\models\search\InformationSearch $searchModel
*/

$this->title = Yii::t('models', 'Informations');
...
?>
<div class="giiant-crud information-index">
...
//             echo $this->render('_search', ['model' =>$searchModel]);
    ...
    <div class="table-responsive">
        ...
        'columns' => [
			...
			[
				'attribute' => 'image',
				'value' => function (\common\models\Information $model){
