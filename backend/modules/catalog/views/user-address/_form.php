...
<!-- attribute series_num -->
			<?= $form->field($model, 'series_num')->textInput(['maxlength' => true]) ?>

<!-- attribute pin_fl -->
			<?= $form->field($model, 'pin_fl')->textInput(['maxlength' => true]) ?>
...
<!-- attribute address -->
    ...
    Tabs::widget(
                 [
                    ...
                    'items' => [ 
                        [
    'label'   => Yii::t('models', 'UserAddress'),
