...
* @var yii\data\ActiveDataProvider $dataProvider
    * @var common\models\search\BlogCommentSearch $searchModel
*/

$this->title = Yii::t('models', 'Blog Comments');
...
?>
<div class="giiant-crud blog-comment-index">
...
//             echo $this->render('_search', ['model' =>$searchModel]);
    ...
    <div class="clearfix crud-navigation">
        ...
        <div class="pull-right">
            ...
            [
                'url' => ['blog/index'],
                'label' => '<i class="glyphicon glyphicon-arrow-left"></i> ' . Yii::t('models', 'Blog'),
            ],
                                [
                'url' => ['user/index'],
    ...
    <div class="table-responsive">
        ...
        'columns' => [
			...
			[
			    ...
			    'value' => function ($model) {
			        if ($rel = $model->blog) {
			            return Html::a($rel->title, ['blog/view', 'id' => $rel->id,], ['data-pjax' => 0]);
			        } else {
			            return '';
			        }
			    },
